...
## Project Structure
    ...
    ├── testapiautoconnecto_68819  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68819`
...
2. Clone this repo and `cd testapiautoconnecto_68819`
